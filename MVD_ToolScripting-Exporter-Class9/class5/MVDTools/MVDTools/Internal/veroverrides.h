...
#define MAXVER_INTERNALNAME "MVDTools\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "MVDTools.gup\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "MVDTools Implementation\0"//should  be overidden on a per-dll level
